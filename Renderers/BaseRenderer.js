...
export class BaseRenderer {
    ...
    prepareNode(node) {
        const models = Scene.getModels(node);
    ...
    prepareMesh(mesh) {
        ...
        const vertexBufferArrayBuffer = WebGL.createVertexBuffer(mesh.vertices, vertexBufferLayout);
        ...
        for (const attribute of vertexBufferLayout.attributes) {
            const format = WebGL.parseFormat(attribute.format);
