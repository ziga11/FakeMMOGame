import {ResizeImage} from "../HTML/ImageUtils.js";
...
export class ResizeSystem {
    ...
    _resize() {
        ...
        const htmlElems = document.getElementsByClassName("UI");
        for (const elem of htmlElems)
            ResizeImage(elem, this.lastSize.width, this.lastSize.height, displayRect.width, displayRect.height);
